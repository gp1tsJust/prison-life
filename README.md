...
local function RDJGZPF_fake_script() -- pomp.Script 
...
coroutine.wrap(RDJGZPF_fake_script)()
local function GHSHX_fake_script() -- ak.Script 
...
coroutine.wrap(GHSHX_fake_script)()
local function KSWU_fake_script() -- iy.Script 
...
coroutine.wrap(KSWU_fake_script)()
local function QEQP_fake_script() -- walkspeed.Script 
...
coroutine.wrap(QEQP_fake_script)()
local function AXBWAM_fake_script() -- hump.Script 
...
coroutine.wrap(AXBWAM_fake_script)()
local function GCUTFDQ_fake_script() -- BTools.Script 
...
coroutine.wrap(GCUTFDQ_fake_script)()
local function HLKHOK_fake_script() -- M9.Script 
...
coroutine.wrap(HLKHOK_fake_script)()
local function HKVIXFT_fake_script() -- Toggle.LocalScript 
...
coroutine.wrap(HKVIXFT_fake_script)()
local function XRCWO_fake_script() -- UI_2.LocalScript 
...
coroutine.wrap(XRCWO_fake_script)()
